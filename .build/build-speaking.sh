    ...
    <div class="hero__grid">
      ...
      <div class="photo-wrap reveal" style="--d:2">
        <figure class="photo photo--portrait reveal">
          <!-- SWAP: assets/img/alaa-stage.jpg -->
          <div class="photo__ph">
            ...
            <span class="photo__label" data-ar="صورة قوية من المسرح — آلاء أثناء المحاضرة والجمهور ظاهر">A strong stage shot &mdash; Alaa mid-talk, audience visible</span>
            <span class="photo__spec">alaa-stage.jpg &middot; 4:5</span>
          </div>
        </figure>
        <div class="photo-chip">
          <span class="photo-chip__icon" aria-hidden="true"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 14.4a3.2 3.2 0 0 0 3.2-3.2V5.6a3.2 3.2 0 1 0-6.4 0v5.6a3.2 3.2 0 0 0 3.2 3.2z"/><path d="M18.6 10.8v.6a6.6 6.6 0 0 1-13.2 0v-.6M12 18v3.4M8.6 21.4h6.8"/></svg></span>
          <span>
            <strong class="photo-chip__k" data-ar="كلمات · حلقات نقاش · جلسات">Keynotes &middot; Panels</strong>
            <span class="photo-chip__v" data-ar="بالعربية والإنجليزية">In English and Arabic</span>
          </span>
        </div>
      </div>
    </div>
  ...
  <div class="wrap">
    <div class="split">
      <div class="split__rail">
        ...
        <div class="figure-card mt-3 reveal" style="--d:1">
        <svg class="diagram" viewBox="0 0 400 240" role="img" aria-labelledby="dl-t">
          <title id="dl-t">The product at the centre, surrounded by the wider experience: discovery, purchase, delivery and relationship</title>
          <g class="d-node"><circle cx="200" cy="120" r="104" class="d-fill-soft"/></g>
          <g class="d-node"><circle cx="200" cy="120" r="70"  class="d-fill-line"/></g>
          <g class="d-node"><circle cx="200" cy="120" r="38"  class="d-fill-deep"/></g>
          <text class="d-text d-text--on" x="200" y="124" text-anchor="middle" data-ar="المنتج">product</text>

          <g class="d-node"><circle cx="200" cy="16"  r="7" class="d-fill-mid"/></g>
          <g class="d-node"><circle cx="304" cy="120" r="7" class="d-fill-mid"/></g>
          <g class="d-node"><circle cx="200" cy="224" r="7" class="d-fill-amber"/></g>
          <g class="d-node"><circle cx="96"  cy="120" r="7" class="d-fill-mid"/></g>

          <text class="d-text" x="200" y="6"   text-anchor="middle" data-ar="الاكتشاف">discovery</text>
          <text class="d-text" x="330" y="124" text-anchor="middle" data-ar="الشراء">purchase</text>
          <text class="d-text" x="200" y="238" text-anchor="middle" data-ar="العلاقة">relationship</text>
          <text class="d-text" x="64"  y="124" text-anchor="middle" data-ar="التسليم">delivery</text>
        </svg>
          <p class="figure-card__cap" data-ar="المنتج هو المركز فقط — أما التجربة فهي كل ما يحيط به.">The product is only the centre &mdash; the experience is everything around it.</p>
        </div>
...
<section class="section" id="talks">
  <div class="wrap">
    ...
    <p class="small mt-2" data-ar="استبدل كل بطاقة بمحتوى موثّق: صورة مصغّرة، عنوان، والجهة، مع رابط للتسجيل.">Replace each card with verified media &mdash; a thumbnail, a title, the organization, and a link to the recording.</p>

    <div class="media-grid mt-3">
      <article class="media-item reveal" style="--d:1">
        <figure class="photo photo--wide">
          <!-- SWAP: assets/img/talk-1.jpg — then link the card to the recording -->
          <div class="photo__ph">
            <svg class="photo__icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.4" y="5" width="19.2" height="15" rx="2.6"/><circle cx="12" cy="12.5" r="3.6"/><path d="M8.2 5 9.6 2.8h4.8L15.8 5"/></svg>
            <span class="photo__label" data-ar="صورة مصغّرة للمحتوى">Thumbnail</span>
          </div>
          <span class="media-item__play" aria-hidden="true"><svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5.2v13.6L19 12z"/></svg></span>
        </figure>
        <div>
          <div class="media-item__k" data-ar="محاضرة أو كلمة رئيسية">Talk or keynote</div>
          <div class="media-item__v" data-ar="اسم الفعالية · السنة">Event name &middot; Year</div>
        </div>
      </article>
      <article class="media-item reveal" style="--d:2">
        <figure class="photo photo--wide">
          <!-- SWAP: assets/img/talk-2.jpg — then link the card to the recording -->
          <div class="photo__ph">
            <svg class="photo__icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.4" y="5" width="19.2" height="15" rx="2.6"/><circle cx="12" cy="12.5" r="3.6"/><path d="M8.2 5 9.6 2.8h4.8L15.8 5"/></svg>
            <span class="photo__label" data-ar="صورة مصغّرة للمحتوى">Thumbnail</span>
          </div>
        ...
        <div>
          <div class="media-item__k" data-ar="ظهور في بودكاست">Podcast appearance</div>
          <div class="media-item__v" data-ar="اسم البرنامج · الحلقة">Show name &middot; Episode</div>
        </div>
      </article>
      <article class="media-item reveal" style="--d:3">
        <figure class="photo photo--wide">
          <!-- SWAP: assets/img/talk-3.jpg — then link the card to the recording -->
          <div class="photo__ph">
            <svg class="photo__icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.4" y="5" width="19.2" height="15" rx="2.6"/><circle cx="12" cy="12.5" r="3.6"/><path d="M8.2 5 9.6 2.8h4.8L15.8 5"/></svg>
            <span class="photo__label" data-ar="صورة مصغّرة للمحتوى">Thumbnail</span>
          </div>
        ...
        <div>
          <div class="media-item__k" data-ar="مقابلة أو حلقة نقاش">Interview or panel</div>
          <div class="media-item__v" data-ar="الجهة · السنة">Outlet &middot; Year</div>
        </div>
      </article>
      <article class="media-item reveal" style="--d:4">
        <figure class="photo photo--wide">
          <!-- SWAP: assets/img/talk-4.jpg — then link the card to the recording -->
          <div class="photo__ph">
            <svg class="photo__icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.4" y="5" width="19.2" height="15" rx="2.6"/><circle cx="12" cy="12.5" r="3.6"/><path d="M8.2 5 9.6 2.8h4.8L15.8 5"/></svg>
            <span class="photo__label" data-ar="صورة مصغّرة للمحتوى">Thumbnail</span>
          </div>
        ...
        <div>
          <div class="media-item__k" data-ar="ورشة عمل أو جلسة">Workshop or session</div>
          <div class="media-item__v" data-ar="المؤسسة · السنة">Organization &middot; Year</div>
        </div>
      </article>
    </div>
