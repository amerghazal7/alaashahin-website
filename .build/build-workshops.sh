...
<section class="section section--dark">
  <div class="wrap">
    <div class="split">
      <div class="split__rail">
        <p class="eyebrow reveal" data-ar="كيف نُشكّل الجلسة">How we shape the session</p>
        <h2 class="h-xl mt-2" data-mask data-ar="مبنية حول <em>جمهورك</em>، لا مسحوبة من عرض تقديمي جاهز.">Built around your <em>audience</em>, not pulled from a standard slide deck.</h2>
      </div>
      <div>
